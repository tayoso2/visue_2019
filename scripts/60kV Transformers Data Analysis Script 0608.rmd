---
title: "Evonet 60kV Transformers with Tapchangers Data Analysis"
output:
  html_document:
    number_sections: yes
    theme: yeti
...
if (EDA) {
  ...
  args <- c(getwd(),
            "./Data/Asset Bases/60kV Transformers Raw Assets_v3 v1 0608.csv",
            "./Output Data/60kV Transformers Population Summary 0608.csv",
            "./Output Data/60kV Transformers For Model 0608.csv", 
            "./Output Data/60kV Transformers GIS 0608.csv")
}
...
columns.infilled <- unique(names(model.data))[!(unique(names(model.data)) %in% c("Area1", "Type", "Evonet_Group", "Asset_Number", "Driftsmrk","X","Y"))]
