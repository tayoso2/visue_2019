...
### Examples ###
asset.attributes <- read.csv("./Evonet/Model/NPI Assets.csv" , check.names = FALSE)
asset.attributes <- asset.attributes[, 1:30]

# Convert several files to long in one operation
long.result <-
  MultipleMakeLong(
    c("./Evonet/Model/NPI Assets.csv","./Evonet/Model/Maintain Risk Assets.csv"),
...
write.csv(long.result, "./Output Data/Evonet long_results.csv", na = "")
write.csv(asset.attributes, "./Output Data/Evonet attributes.csv", na = "")
