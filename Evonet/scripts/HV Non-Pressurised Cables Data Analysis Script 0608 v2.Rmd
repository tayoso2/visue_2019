...
# ggplot(cables.assets, aes(x = as.integer(as.numeric(Year_Of_Manufacture)))) +
#       geom_density() +
#        labs(title="Distribution of 10/15kV Cables by Year Of Manufacture", x="Year of Manufacture", y="Density")
